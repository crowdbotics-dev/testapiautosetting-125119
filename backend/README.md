...
## Project Structure
    ...
    ├── testapiautosetting_125119  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_125119`
...
2. Clone this repo and `cd testapiautosetting_125119`
